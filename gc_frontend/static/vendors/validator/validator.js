...
var validator = (function ($) {
    ...
    */
    message = {
        ...
        min: 'la entrada es demasiado corta',
        max: 'la entrada es demasiado larga',
    ...
    */
    tests = {
        ...
        date: function (a) {
            ...
            // Si el navegador soporta `valueAsNumber`, lo usamos
            if (field[0].valueAsNumber) {
                var inputDate = new Date(field[0].valueAsNumber);
                var today = new Date();
        
                // Normalizamos las horas a medianoche para comparar solo fechas
                today.setHours(0, 0, 0, 0);
                inputDate.setHours(0, 0, 0, 0);
        
                var tomorrow = new Date(today);
                tomorrow.setDate(today.getDate() + 1); // Obtenemos mañana
        
                if (inputDate < today) {
                    alertTxt = "Fecha pasada";
                    return false;
                }
            ...
            // Si el navegador no soporta `valueAsNumber`, validamos manualmente
            for (i = A.length; i--;) {
            ...
            try {
                ...
                return day.getMonth() + 1 == A[1] && day.getDate() == A[0];
            } catch (err) {
                console.log('Error en validación de fecha: ', err);
                return false;
            }
        },        
        url: function (a) {
        ...
        time: function (a) {
            ...
            // Validamos que la hora esté dentro del rango permitido (08:00 - 18:00)
            if (hours < 8 || hours > 18 || (hours === 18 && minutes > 0)) {
                alertTxt = "Hora fuera de rango (08:00 - 18:00)";
                return false;
            }
